...
namespace Project
{
    public partial class Guest_Hotel_Services : Form
    {
        Controller controllerObj;
        int guestssn;
        public Guest_Hotel_Services(int ssn)
        {
            InitializeComponent();
        ...
        private void Hotel_Services_Load(object sender, EventArgs e)
        {
            if (comboBox1.Text == "")
            {
                ...
                DataTable dta = controllerObj.ProcSrID();
                ...
                {
                    dataGridView1.Visible = false;
                    MessageBox.Show("Sorry, No service available right now");
