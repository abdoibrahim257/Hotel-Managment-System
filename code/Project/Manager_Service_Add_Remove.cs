...
namespace Project
{
    public partial class Manager_Service_Add_Remove : Form
    {
        ...
        public Manager_Service_Add_Remove(string UsrName, string Pass, int Manager_SSN, DataTable profit)
        {
            InitializeComponent();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if(textBox1.Text!="")
            {
                ...
                int x = controllerObj.ProcInsertService(serviceID, textBox1.Text, Convert.ToInt32(numericUpDown2.Value), Convert.ToInt32(numericUpDown3.Value), ManagerSSN);
                if (x == 1)
                {
