...
namespace Project
{
    public partial class Manager_Program_Add_Remove : Form
    {
        ...
        public Manager_Program_Add_Remove(string usrName, string pass, int ssn, DataTable profit)
        {
            InitializeComponent();
        ...
        {
                int programID = Convert.ToInt32(numericUpDown1.Value);
                DataTable dt = controllerObj.ProcSelectProgram(Convert.ToInt32(numericUpDown1.Value));
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                int programID = Convert.ToInt32(numericUpDown1.Value);
                DataTable dt = controllerObj.ProcSelectProgram(programID);
