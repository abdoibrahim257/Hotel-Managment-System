...
namespace Project
{
    public partial class Manager_Statistics : Form
    {
        ...
        public Manager_Statistics(string usrname, string password, DataTable profit, int SSN)
        {
        ...
        {
            Manager_Expenses_Add a = new Manager_Expenses_Add(managerSSN);
            a.Show();
        }
